...
import {increment, decrement, clearAll} from "../../store/modules/takeaway";
	...
	return (
		<div className="cartContainer">
			...
			<div className="cart">
				...
				<div className={classNames('icon', cartList.length > 0 ? 'fill' : '')} onClick={() => {
					setVisible(true)
				}}>
